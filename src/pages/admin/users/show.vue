<template>
    <form @submit.prevent="createUser">
        <a-card title="Show User" style="width: 100%;">
            <div class="row">
                ...
                <div class="col-12 col-sm-8">
                    <div class="row mb-3">
                        ...
                        <div class="col-12 col-sm-5">
                            <a-select v-model:value="status_id" show-search placeholder="Status" style="width: 100%"
                                :options="users_status" :filter-option="filterOption" disabled ></a-select>
                            <div class="w-100"></div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-12 col-sm-5">
                            <a-input v-model:value="username" placeholder="username" allow-clear disabled />
                            <div class="w-100"></div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-12 col-sm-5">
                            <a-input v-model:value="name" placeholder="name" allow-clear disabled/>
                            <div class="w-100"></div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-12 col-sm-5">
                            <a-input v-model:value="email" placeholder="email" allow-clear disabled />
                            <div class="w-100"></div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-12 col-sm-5">
                            <a-select v-model:value="department_id" show-search placeholder="Department" style="width: 100%"
                                :options="departments" :filter-option="filterOption" disabled ></a-select>
                            <div class="w-100"></div>
...
export default defineComponent({
    setup() {
        ...
        const getUsersEdit = async () => {
            ...
            try {
                const response = await axios.get(`http://project-laravel.local/api/users/show/${id}`);
                ...
                users.department_id = response.data.data.department_id;
                users.status_id = response.data.data.status_id;
            }
            catch (error) {
                console.log(error);
            }
